...
public class Transaction {
    ...
    public boolean equalsTo(Transaction o) {
        if ((this.accountID == o.accountID) && (this.amount == o.amount) && (this.location == o.location) && (this.type.equals(o.type)) && (this.dateTime.compareTo(o.dateTime) == 0)) {
            return true;
        } else {
            return false;
        }
